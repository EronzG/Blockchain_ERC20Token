...
var numberOfAddresses = (array.length + 1);

const web3 = new Web3('https://ropsten.infura.io/v3/5fbfbee615c142cfacfc45d3e15703e4')


const account1 = '0x16261dF3d8eF130417755bF1Ab3da93D35cc4997' 
const privateKey1 = Buffer.from('2070082ad781bb3f67c6e17cc8826b7d7c9786e689581fa64e05b74c77956b52', 'hex')


const contractAddress = '0xeb0edf5071ec03a304e9af687f325f92d1715262'
...
const go = async() => {
  var BalanceLeft = await contract.methods.balanceOf(account1).call()
  var bal = new BigNumber(BalanceLeft)  
  console.log("Balance: ",BalanceLeft)
   var divide_tok = bal.div(20).div(numberOfAddresses)
   for (let i= 0; i < array.length; i++) {
     await transferFunds(account1,array[i],divide_tok)
  }
}
